...
报告日期 2026-09-19（周六盘前；国内 SHFE/上金所最新收盘 09-18；LME 09-16 收盘，东财日K末点口径）
...
_price_comment = ('- 周六盘前国内最新为 9 月 18 日收盘：沪铅 +2.03% 领涨，沪锡 +1.97%、沪锌 +1.59%、'
    '沪铜 +1.4%、沪镍 +0.98%、沪铝 +0.74% 普涨，沪银 +3.98%、沪金 +1.41% 走强，碳酸锂主连 -2.27% 回落；'
    'LME 六金属多数上涨，伦锌 +1.84%、伦铜 +1.67%、伦铅 +1.49%、伦锡 +1.34%、伦镍 +1.32%、伦铝 +0.72%'
    '（LME 数据日期 9 月 16 日，东财日K尚未更新 9 月 17 日及以后，卡片沿用最近已收盘交易日）。'
    '驱动上，美联储加息落地后美元指数持稳于 100.25 附近，贵金属在政策预期博弈下大幅走强，白银单日涨近 4%；'
    '基本金属受铜矿供应收缩预期与国内库存去化支撑普遍上涨——Sprott 报告称上半年全球铜矿产量同比降 1.1%，'
    '全年或出现 2017 年以来首次下滑；碳酸锂因广期所提高最小开仓量与手续费标准、供需博弈加剧而大幅回落，'
    '黑色系双焦重挫，焦煤跌 7.78%。整体呈「基本金属普涨、贵金属强势、锂与双焦走弱」格局。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '沪铅 +2.03%、沪锡 +1.97%、沪锌 +1.59% 领涨，沪铜 +1.4%；沪银 +3.98%、沪金 +1.41%。'},
    {'cat': '行情', 'k': '',
     't': 'LME 六金属多数上涨：伦锌 +1.84%、伦铜 +1.67%、伦铅 +1.49%、伦锡 +1.34%。'},
    {'cat': '政策与产业', 'k': '广期所调整碳酸锂',
     't': '广期所调整碳酸锂 12 个合约：最小开仓 2 手、手续费万分之零点八、单日开仓 800 手。'},
    {'cat': '政策与产业', 'k': '历史遗留废弃矿山生态修复',
     't': '自然资源部公示「十五五」历史遗留废弃矿山生态修复 22 个项目审核结果。'},
    {'cat': '政策与产业', 'k': '几内亚大走廊',
     't': '中企联合体几内亚大走廊矿业物流项目推进，总投资超 30 亿美元，铝土矿年外运 7700 万吨。'},
    {'cat': '政策与产业', 'k': '敖宏到铜陵有色',
     't': '有色协会敖宏到铜陵有色调研，强调稳妥推进海外资源布局、提升供应链韧性。'},
    {'cat': '勘查与技术', 'k': '南澳州奥弗兰',
     't': 'AR3 南澳州奥弗兰铌稀土矿 OV176 孔见 130 米厚碳酸岩体，铌 0.53%、镨钕最高 22%。'},
    {'cat': '勘查与技术', 'k': '矿产资源家底',
     't': '《中国矿产资源报告（2026）》：我国 14 种矿产储量世界第一，2025 年新发现矿产地 200 处。'},
    {'cat': '勘查与技术', 'k': 'Aya 摩洛哥',
     't': 'Aya 摩洛哥 Zgounder 银矿坑边见矿 13 米、银品位 783 克/吨，本轮公布 97 孔结果。'},
    {'cat': '勘查与技术', 'k': 'Lithium Africa',
     't': 'Lithium Africa 科特迪瓦 Agboville 项目见 1.98% 氧化锂，矿化延伸 2.8 公里。'},
    {'cat': '并购与投资', 'k': '中国五矿拟增资',
     't': '中国五矿拟增资广西关键金属集团取得 51% 股权，华锡有色实控人将变更为中国五矿。'},
    {'cat': '并购与投资', 'k': '赣锋锂业 1.8 亿美元',
     't': '赣锋锂业 1.8 亿美元可转债投资 Lithium Argentina 交割，全额转股后持股升至 16.1%。'},
    {'cat': '并购与投资', 'k': '中国稀土集团洽购',
     't': '中国稀土集团洽购盛和资源，或间接持有美国 MP Materials 约 3% 权益。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿权专区今日新增 1 宗：内蒙古林西县边家大院北铅矿勘查探矿权挂牌出让，面积 3.2095 平方千米。'},
]
