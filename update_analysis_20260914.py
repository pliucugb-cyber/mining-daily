...
报告日期 2026-09-14（周一盘前；国内 SHFE/上金所最新收盘 09-11；LME 09-11 收盘）
...
_price_comment = ('- 周一盘前国内尚无用当日行情，沪市最新为 9 月 11 日收盘：白银 -5.07%、碳酸锂 -4.59%、沪锡 -3.64%、沪铜 -2.86%，'
    '仅沪铅相对抗跌（-0.22%）；LME 9 月 11 日收盘涨跌互现（伦铜 +0.31%、伦锌 +0.22%，伦锡 -1.69%、伦镍 -0.60%），内外盘延续分化。'
    '铜价周内触及 14,875 美元/吨纪录高位后单日回落 3.6%，全周下跌 1.2%、终结连续 10 周上涨；上期所铜库存连降两周、骤降 13% 至 54,780 吨'
    '（2024 年 1 月以来最低），LME 可用铜库存维持 117,600 吨不变。驱动来自美国 8 月 PPI 超预期与美联储偏鹰预期升温，'
    '据 SMM 隔夜行情，贵金属跳水、基本金属普跌且伦锡与沪镍跌幅居前，氧化铝逆势涨超 2%，短期波动预计继续放大。')# 「政策与产业」= 政策与监管 + 行业动态 两源（2026-09-12 修正）：
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '领涨：LME 铜 14,226 美元/吨（+0.31%）；领跌：白银 15,586 元/千克（-5.07%）。'},
    {'cat': '行情', 'k': '',
     't': '周一盘前国内暂无当日行情，沪市仍为 9 月 11 日收盘（沪铜 -2.86%、碳酸锂 -4.59%）；LME 铜周线 6 月以来首跌 1.2%。'},
    {'cat': '政策与产业', 'k': '规范矿业权管理',
     't': '《规范矿业权管理有关事项的通知（征求意见稿）》结束意见征集，共收到建议 279 条，将最大程度吸收采纳。'},
    {'cat': '政策与产业', 'k': '14 种矿产储量',
     't': '《中国矿产资源报告 2026》与《全球矿业发展报告 2026》发布，我国 14 种矿产储量居世界第一。'},
    {'cat': '政策与产业', 'k': '绿色矿山',
     't': '绿色勘查、绿色矿山系列国家标准集中发布，覆盖主要矿产类型与勘查—开发全流程，绿色矿业标准体系进一步完善。'},
    {'cat': '政策与产业', 'k': '力拓',
     't': '力拓西澳 Winu 铜金项目获 Nyangumarta 原住民同意，扫清开发障碍，项目可继续推进。'},
    {'cat': '勘查与技术', 'k': 'Alchemy',
     't': 'Alchemy 在新南威尔士 Yellow Mountain 启动铜金靶区反循环钻探，计划最多 15 孔；以往见矿 113 米、铜当量 1.17%。'},
    {'cat': '并购与投资', 'k': 'Freeport',
     't': '自由港 CEO 释放推进信号：亚利桑那 Bagdad 铜矿扩建资本开支上调至约 45 亿美元，较原估算增约 30%。'},
    {'cat': '并购与投资', 'k': '力拓',
     't': '力拓西澳 Winu 铜金项目获原住民同意，公司称将与 Nyangumarta 建立长期伙伴关系并推进开发。'},
    {'cat': '矿权市场', 'k': '',
     't': '今日矿权窗口无新增公告；在库最新为 09-12 发布的新疆铜金矿、陕西煤井田、贵州粉石英等出让与转让公示。'},
]
