...
报告日期 2026-09-21（周一盘前，国内未开盘；国内 SHFE/上金所最新收盘 09-18；LME 09-18 收盘，东财日K末点已追平）
...
_price_comment = ('- 周一盘前国内尚未开盘，最新为 9 月 18 日收盘：沪锡 +1.45%、沪铅 +1.21%、沪锌 +1.08%、沪铜 +1.03% 领涨，'
    '沪铝 +0.72%、沪镍 +0.40% 跟涨；贵金属继续走强，沪银 +4.56%、沪金 +1.75%；碳酸锂主连 -3.06% 回落。'
    'LME 六金属多数上涨，且行情末点本日已追平至 9 月 18 日收盘（东财日K此前连续三日停留在 9 月 16 日）：'
    '伦锌 +1.52%、伦锡 +0.87%、伦铜 +0.68%、伦铅 +0.52%、伦铝 +0.30%，仅伦镍 -0.18%。'
    '驱动上，伦锌走出独立领涨的挤仓行情，当周成交 12532 手、持仓 261291 手环比双双回落，风险边界收窄；'
    '铜矿现货加工费指数跌至 -221.89 美元/干吨的历史新低，冶炼厂计划 10—11 月集中检修并已通知客户削减长单交付，'
    '中国精炼铜社会库存较年内高点下降近 50 万吨、降幅逾八成，市场结构由 contango 转向 backwardation；'
    '钴价 9 月累计下跌 7.17%、较年初跌逾 39%，「金九」旺季预期落空。'
    '美国对进口铝加征 50% 关税的反噬开始向实体端传导，Novelis 金斯敦工厂裁员约 80 人。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '沪锡 +1.45%、沪铅 +1.21%、沪锌 +1.08%、沪铜 +1.03% 领涨；沪银 +4.56%，碳酸锂 -3.06%。'},
    {'cat': '行情', 'k': '',
     't': 'LME 末点已追平 09-18：伦锌 +1.52%、伦锡 +0.87%、伦铜 +0.68%、伦铝 +0.30%、伦镍 -0.18%。'},
    {'cat': '政策与产业', 'k': '巴西关键矿产立法',
     't': '巴西推进关键矿产立法、强化矿业交易审查；阿根廷拟将稀土列为国家战略资产。'},
    {'cat': '政策与产业', 'k': '多米尼加',
     't': '多米尼加汇总稀土样品 5000 项，计划 11 月定资源量、2027 上半年公布首个储量。'},
    {'cat': '政策与产业', 'k': '中金岭南',
     't': '中金岭南凡口铅锌矿完成整改，9 月 17 日复产，停产产量损失尚未量化。'},
    {'cat': '政策与产业', 'k': '神火集团',
     't': '神火集团 5 万吨钠离子电池铝箔项目开工，24 个月建成后加工能力达 16.5 万吨。'},
    {'cat': '勘查与技术', 'k': '四川冕宁-德昌',
     't': '四川冕宁-德昌稀土成矿带探获隐伏矿体，3 层矿体累计视厚度约 22.4 米。'},
    {'cat': '勘查与技术', 'k': '西澳州艾雷隆铌矿',
     't': '恩康特西澳艾雷隆项目见 51 米、五氧化二铌品位 5% 矿段，最高单段 10.4%。'},
    {'cat': '并购与投资', 'k': '百色高新区',
     't': '百色高新区签约 5 个铝深加工项目，总投资约 26 亿元。'},
    {'cat': '并购与投资', 'k': 'SK On',
     't': 'SK On 与 NeoVolta 签 2027—2031 年 18GWh 磷酸铁锂储能电池供货协议。'},
    {'cat': '并购与投资', 'k': '克里蒂卡尔',
     't': '克里蒂卡尔拟在罗马尼亚建稀土冶炼厂，投资 18.5 亿美元、测算年收入 22 亿美元。'},
    {'cat': '并购与投资', 'k': '贵宝科技',
     't': '贵宝科技向子公司增资 1 亿元，推进年产 5 万吨硅碳负极及粘合剂项目。'},
    {'cat': '矿权市场', 'k': '',
     't': '今日无新增矿权公告，最新一批为 9 月 18 日挂牌出让与转让公示。'},
]
