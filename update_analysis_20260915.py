...
报告日期 2026-09-15（周二盘前；国内 SHFE/上金所最新收盘 09-14；LME 09-14 收盘）
...
_price_comment = ('- 周二盘前国内尚有当日行情，沪市最新为 9 月 14 日收盘：沪锡 -2.98%、沪铅 -1.92%、沪锌 -1.75%、沪镍 -1.32%，'
    '沪铜 -1.06%、沪铝 -0.83%，白银相对抗跌（-0.37%）；LME 六个品种同步走弱，伦锡 -2.58%、伦锌 -1.53%、伦铜 -1.42%，伦铝仅 -0.15%。'
    '驱动来自美联储 9 月加息预期升温（市场押注概率约 90%）与美国铜关税政策摇摆，叠加地缘冲突推升能源溢价，'
    '市场在「金融属性估值下杀」与「供应溢价」之间剧烈分化；国内基本金属全线收跌，短期波动预计继续放大。')# 「政策与产业」= 政策与监管 + 行业动态 两源（2026-09-12 修正）：
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '沪市 15 个品种全线收跌：沪锡 398,050 元/吨（-2.98%）、沪铅（-1.92%）领跌，白银 -0.37% 最抗跌。'},
    {'cat': '行情', 'k': '',
     't': 'LME 六品种同步走弱：伦锡 51,830 美元/吨（-2.58%）、伦锌 -1.53%、伦铜 -1.42%，伦铝仅 -0.15%。'},
    {'cat': '政策与产业', 'k': '天津宣言',
     't': '矿业国际合作部长论坛在天津举行，发布《矿业绿色发展天津宣言》，围绕绿色发展等 10 个方面提出倡议。'},
    {'cat': '政策与产业', 'k': '国际矿业大会闭幕',
     't': '2026 中国国际矿业大会闭幕，60 个国家和国际组织、3.1 万名参会者参加，达成多项地质矿产合作共识。'},
    {'cat': '政策与产业', 'k': '锡业股份',
     't': '锡业股份上半年营收 316 亿元、同比增长 49.68%，扣非归母净利润 19.46 亿元、同比增长 49.30%。'},
    {'cat': '政策与产业', 'k': '天策',
     't': '陕西有色天策百吨级中间相沥青基碳纤维产线投产，全球仅 3 家企业掌握规模化生产能力。'},
    {'cat': '勘查与技术', 'k': '马库库',
     't': '艾芬豪刚果（金）马库库铜矿铜金属资源量增至约 1200 万吨（+30%），推定品位 2.66%。'},
    {'cat': '勘查与技术', 'k': '布马丁',
     't': '摩洛哥布马丁多金属矿税后净现值翻倍至 35 亿美元，内部收益率 93%，可采年限扩至 14 年。'},
    {'cat': '勘查与技术', 'k': 'NICICO',
     't': '伊朗 NICICO 称铜矿石资源量增至 245 亿吨（+10.6%），前五个月完成勘查钻探近 20 万米。'},
    {'cat': '并购与投资', 'k': 'Trilogy',
     't': '美国政府以 3560 万美元入股 Trilogy Metals 获 10% 股权，用于推进阿拉斯加铜锌矿项目。'},
    {'cat': '并购与投资', 'k': '焦作万方',
     't': '焦作万方终止发行股份购买资产暨关联交易事项，并向监管机构撤回申请文件，重组终止。'},
    {'cat': '矿权市场', 'k': '',
     't': '今日矿权专区无新增出让公告（在库最新为 09-12 发布的 10 宗挂牌/出让公示）；企业侧新增盛达资源采矿权延续登记。'},
]
