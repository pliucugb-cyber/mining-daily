...
**政策与产业：**
- AI 算力建设拉动"算力金属"需求：华夏时报报道铜、铝等工业金属价格集体走高，产业链利润向资源端转移。
- 新能源汽车、光伏、储能及 AI 算力等新需求成为有色金属行业增长引擎（中国网），铜、铝、锂等品种长期需求获支撑，行业由传统基建驱动转向多元新兴需求驱动。
- 盛屯矿业拟以 7.09 亿元收购西藏海腾矿业股权，加码锌资源布局，强化上游原料保障与一体化能力。
- 和讯有色金属周报回顾本周铜、铝、锌、镍走势，铜锌偏强、镍铝走弱，提示关注库存与宏观扰动对价格的影响。
- 华安期货金属早盘策略：铜锌逢低偏多、镍铝反弹承压，关注宏观与库存变化。

**勘查与技术：**
- 柳园铭扬铜镍矿第三孔支撑性勘探顺利开钻（中国地质调查局西宁中心）：5 号机台 MZK002 号孔在前两孔基础上加密勘探剖面、完善地质数据，为资源储量核实与灾害隐患排查提供依据；施工结合西藏吉隆泥石流教训，全程强化安全管控与地质灾害防控。
...
**风险提示：** 碳酸锂主力 09-04 单日 -5.30%、两日累计跌逾 12%，短线情绪偏弱，关注锂价下行对上游矿企利润的压制；西藏吉隆"8·26"冰岩崩—泥石流灾害链次生风险仍处高位，源区残留不稳定冰川与岩体需持续监测；周一国内尚无新收盘，价格卡沿用 09-04 数据，盘中波动以 LME 09-07 电子盘为参考。""".strip()
