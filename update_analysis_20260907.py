...
**风险提示：** 碳酸锂主力 09-04 单日 -5.30%、两日累计跌逾 12%，短线情绪偏弱，关注锂价下行对上游矿企利润的压制；西藏吉隆"8·26"冰岩崩—泥石流灾害链次生风险仍处高位，源区残留不稳定冰川与岩体需持续监测；周一国内尚无新收盘，价格卡沿用 09-04 数据，盘中波动以 LME 09-07 电子盘为参考。""".strip().format(policy_text=policy_text, tech_text=tech_text)
