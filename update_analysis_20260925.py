...
报告日期 2026-09-25（周五盘前，国内未开盘；国内 SHFE/上金所最新收盘 09-24；LME 09-24 收盘，东财日K末点=09-24）
...
_price_comment = ('- 星期五 盘前国内尚未开盘，最新为 09-24 日收盘：沪锌 +0.92%、沪锡 +0.45% 收涨，碳酸锂 -3.48%、白银 -3.12%、上海金 -1.26% 走弱。LME 六金属（行情末点与价格卡同源，均为 09-24 日收盘）：伦锌 +1.73%、伦铅 +0.49%、伦镍 +0.30%、伦铜 +0.21%、伦铝 +0.05% 上涨，伦锡 -0.20% 微跌。驱动上，国内基本金属窄幅整理、贵金属与碳酸锂承压；外盘美元走软叠加中东局势推升油价，基本金属多数收涨。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': 'LME 锌 +1.73%、铅 +0.49%、镍 +0.30%、铜 +0.21% 上涨，锡 -0.20% 微跌（09-24 收盘）。'},
    {'cat': '行情', 'k': '',
     't': '国内 09-24 收盘：沪锌 +0.92%、沪锡 +0.45% 收涨，碳酸锂 -3.48%、白银 -3.12% 走弱。'},
    {'cat': '政策与产业', 'k': '阿根廷',
     't': '美国进出口银行 2027 年前向阿根廷能源、矿业与基建提供最高 70 亿美元贷款。'},
    {'cat': '政策与产业', 'k': '刚果',
     't': '刚果（金）拟设矿业投资促进机构，重点面向投资额超 10 亿美元的合资项目。'},
    {'cat': '政策与产业', 'k': '卡通巴',
     't': '中矿资源赞比亚卡通巴铜矿选矿厂建成投产，项目转入生产运营阶段。'},
    {'cat': '政策与产业', 'k': '江特电机',
     't': '江特电机推进茜坑锂矿开发，该矿为国内首个在自然资源部办证的锂云母矿。'},
    {'cat': '勘查与技术', 'k': '费尔凯',
     't': '科特迪瓦费尔凯金矿 970 米深处见矿 116.5 米、金品位 1.76 克/吨，深部潜力扩大。'},
    {'cat': '勘查与技术', 'k': '于沟',
     't': '江西物化探大队在阿尔金山 4500 米以上高原推进于沟钼多金属矿普查物探施工。'},
    {'cat': '勘查与技术', 'k': '中铝科学院',
     't': '中铝科学院赤泥两步法炼铁、废阴极炭块制铝离子电池正极材料取得技术突破。'},
    {'cat': '并购与投资', 'k': '盛屯矿业',
     't': '盛屯矿业完成收购西藏海腾实业 65% 股权交割，已付股权转让款 6.885 亿元。'},
    {'cat': '并购与投资', 'k': '中稀有色',
     't': '中稀有色以 1.42 亿元向东电化（中国）投资转让广晟稀土 37% 股权。'},
    {'cat': '并购与投资', 'k': '嘉友国际',
     't': '嘉友国际签布隆迪锂辉矿 7 年合作协议，获独家物流与锂辉石销售代理权。'},
    {'cat': '并购与投资', 'k': '五矿发展',
     't': '五矿发展重大资产置换及发行股份购买资产申请文件获上交所受理。'},
    {'cat': '并购与投资', 'k': 'Tungsten West',
     't': 'Tungsten West 与 Elmet 签 8 年承购协议，年供 1000 吨 WO₃ 货值约 18 亿美元。'},
    {'cat': '并购与投资', 'k': '印度斯坦铜业',
     't': '印度斯坦铜业股东会议批准 7.76 亿美元扩产融资，矿石产能目标翻三倍。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿权市场窗口内新增 9 宗：河南汝州张沟铝土矿普查挂牌、安徽 4 宗多金属矿探矿权转让等。'},
]
