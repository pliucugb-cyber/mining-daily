...
报告日期 2026-09-17（周四盘前；国内 SHFE/上金所最新收盘 09-16；LME 09-16 收盘）
...
_price_comment = ('- 周四盘前国内最新为 9 月 16 日收盘：沪银 +2.46%、沪锡 +1.41% 领涨，沪金 +0.88%、沪铜 +0.66%、'
    '沪铅 +0.60%、沪锌 +0.59%、沪铝 +0.33% 普涨，沪镍 -1.54% 独自走弱，碳酸锂 -2.56% 跌幅居前；'
    'LME 同步偏强，伦镍 +1.32%、伦锡 +1.18%、伦铜 +0.96%、伦铝 +0.72%、伦铅 +0.35%，仅伦锌 -0.55%。'
    '驱动上，市场等待美联储议息结果，美元走弱提振金属与贵金属，沪银单日涨幅居国内品种之首；'
    '沪铜库存连降 3 周、刷新逾两年最低位，铜精矿现货加工费持续下跌叠加硫酸价格回落，冶炼供应增量受限，为铜价提供支撑；'
    '镍内外盘背离，印尼年内再次修订镍矿内贸基准价（HPM）公式，令镍矿定价与冶炼成本预期重估。'
    '整体呈「美元走弱、多数反弹、镍锂分化」格局。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '沪银 +2.46%、沪锡 +1.41% 领涨，沪铜 +0.66%、沪铝 +0.33% 普涨，沪镍 -1.54%、碳酸锂 -2.56% 走弱。'},
    {'cat': '行情', 'k': '',
     't': 'LME 多数上涨：伦镍 +1.32%、伦锡 +1.18%、伦铜 +0.96%，仅伦锌 -0.55%，市场等待美联储议息。'},
    {'cat': '政策与产业', 'k': '绿色矿山系列国家标准',
     't': '《绿色矿山建设规范》系列国家标准发布共 10 个部分，覆盖煤炭、有色、黄金、砂石等主要矿产类型。'},
    {'cat': '政策与产业', 'k': '规范矿业权管理通知',
     't': '规范矿业权管理通知征求意见结束，共收到社会各界意见 279 条，将最大程度吸收采纳。'},
    {'cat': '政策与产业', 'k': '14 种矿产储量',
     't': '两部矿业权威报告发布：我国稀土、钨、锡等 14 种矿产储量居世界第一，9 种居世界前四。'},
    {'cat': '政策与产业', 'k': '8 月原铝产量',
     't': '8 月原铝产量 398 万吨创历史新高，高利润驱动冶炼厂全力释放产能。'},
    {'cat': '政策与产业', 'k': '上期所调整锡',
     't': '上期所调整锡品种套期保值持仓额度自动转化标准，优化锡期货合约风控参数。'},
    {'cat': '勘查与技术', 'k': '通杜卢',
     't': '马拉维通杜卢稀土矿钻探见富矿：91 米见矿 TREO 1.51%，重稀土-钇品位最高 16.09%。'},
    {'cat': '勘查与技术', 'k': '中沙地学',
     't': '中沙地学合作首批 24 幅 1∶10 万精细地质填图成果发布，总面积 7.08 万平方千米。'},
    {'cat': '勘查与技术', 'k': '镁稀土合金',
     't': '洛阳特种材料研究院攻克超大规格镁稀土合金构件制备难题，突破凝固组织均匀性控制瓶颈。'},
    {'cat': '并购与投资', 'k': '焦作万方',
     't': '焦作万方终止发行股份购买资产暨关联交易事项并撤回申请文件，重组推进多时后叫停。'},
    {'cat': '并购与投资', 'k': '紫金矿业全资子公司',
     't': '紫金矿业全资子公司拟与关联人共同投资，属关联交易范畴，已按规履行披露程序。'},
    {'cat': '并购与投资', 'k': '永臻股份',
     't': '永臻股份拟投建年产 6 万吨成品电池铝箔项目，扩张锂电铝箔环节供应能力。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿权专区今日新增 13 宗：挂牌出让 3、结果公示 5、转让公示 5，含酉阳毛家锑矿、于田无草滩金铜矿。'},
]
