...
报告日期 2026-09-13（周日休市；国内 SHFE/上金所最新收盘 09-11；LME 09-11 收盘）
...
_price_comment = ('- 周日国内休市，沪市最新为 9 月 11 日收盘：白银 -5.07%、碳酸锂 -4.59%、沪锡 -3.64%、沪铜 -2.86%，'
    '仅沪铅相对抗跌（-0.22%）；LME 9 月 11 日收盘涨跌互现（伦铜 +0.31%、伦锌 +0.22%，伦锡 -1.69%、伦镍 -0.60%），'
    '内外盘延续分化。铜价周四触及 14,875 美元/吨纪录高位后单日回落 3.6%，全周下跌 1.2%、终结连续 10 周上涨，'
    '市场聚焦白宫是否对铜加征关税；上期所铜库存连降两周、骤降 13% 至 54,780 吨（2024 年 1 月以来最低），'
    'LME 可用铜库存维持 117,600 吨不变。驱动仍来自美国 8 月 PPI 超预期、欧洲央行加息与美联储偏鹰预期升温，'
    '短期波动预计继续放大。')
...
BRIEF_DIGEST = [
    ...
    {'cat': '行情', 'k': '',
     't': '周日国内休市，沪市仍为 9 月 11 日收盘（沪铜 -2.86%、碳酸锂 -4.59%）；LME 铜周线 6 月以来首跌 1.2%。'},
    {'cat': '政策与产业', 'k': '会见多国矿业部长',
     't': '自然资源部领导在天津会见哈萨克斯坦、刚果（金）等 9 国矿业部长；中国地质调查局与苏丹签署地学合作备忘录。'},
    {'cat': '政策与产业', 'k': '能源部',
     't': '美国能源部拨款 7,300 万美元建 4 处采矿技术测试场，含亚利桑那大学地下测试场与南方卫理公会大学合成矿山。'},
    {'cat': '政策与产业', 'k': '营口建发盛海',
     't': '营口建发盛海一期 30 万吨阴极铜项目熔炼炉 9 月 12 日点火进入烘炉，规划总产能 60 万吨/年、一期配套硫酸 118 万吨。'},
    {'cat': '勘查与技术', 'k': '中沙地学合作',
     't': '沙特地盾首批 24 幅 1:10 万精细地质填图成果发布，总面积 7.08 万平方千米，新识别一批矿化异常与找矿线索。'},
    {'cat': '并购与投资', 'k': '加拿大总理',
     't': '加拿大总理卡尼 9 月 14—15 日峰会推介 66 页投资手册，167 项机会中矿业占 63 项，目标五年引资 1 万亿加元。'},
    {'cat': '并购与投资', 'k': 'Cyclic',
     't': 'Cyclic Materials 在亚利桑那投运商业规模稀土磁材回收厂，年处理含磁体报废产品能力最高 2.5 万吨。'},
    {'cat': '矿权市场', 'k': '',
     't': '今日新增 10 宗矿权公告：新疆铜金矿 3 宗、陕西煤井田 2 宗、贵州粉石英 3 宗、赤峰铅锌/银锡矿协议出让 2 宗。'},
]
