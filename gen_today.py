...
# ========== STEP 5: Update SHFE price cards ==========
old_price_pattern = r'<div class="price-cards" id="priceCardsShfe">.*?(?=<div class="price-cards" id="priceCardsLme")'
new_price_html = (
    '<div class="price-cards" id="priceCardsShfe">'
    '<div class="price-card up" data-slug="lcpt" data-name="沪铜">'
    '<div class="pc-name">沪铜 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">108,570</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9650; +460 (+0.43%)</div></div>'
    '<div class="price-card up" data-slug="lalt" data-name="沪铝">'
    '<div class="pc-name">沪铝 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">24,350</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9650; +290 (+1.21%)</div></div>'
    '<div class="price-card down" data-slug="lldt" data-name="沪铅">'
    '<div class="pc-name">沪铅 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">16,105</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9660; -65 (-0.40%)</div></div>'
    '<div class="price-card up" data-slug="lznt" data-name="沪锌">'
    '<div class="pc-name">沪锌 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">26,665</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9650; +20 (+0.08%)</div></div>'
    '<div class="price-card down" data-slug="ltnt" data-name="沪锡">'
    '<div class="pc-name">沪锡 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">414,770</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9660; -1,050 (-0.25%)</div></div>'
    '<div class="price-card up" data-slug="lnkt" data-name="沪镍">'
    '<div class="pc-name">沪镍 <span class="pc-tag">SHFE</span></div>'
    '<div class="pc-value">128,890</div>'
    '<div class="pc-unit">元/吨</div>'
    '<div class="pc-chg">&#9650; +2,280 (+1.80%)</div></div>'
    '<div class="price-card ">'
    '<div class="pc-name">上海金 <span class="pc-tag">早盘价</span></div>'
    '<div class="pc-value">931.36</div>'
    '<div class="pc-unit">元/克</div>'
    '<div class="pc-chg">今开 939.99</div></div>'
    '<div class="price-card ">'
    '<div class="pc-name">白银 <span class="pc-tag">Ag(T+D)</span></div>'
    '<div class="pc-value">15,659</div>'
    '<div class="pc-unit">元/千克</div>'
    '<div class="pc-chg">今开 15,659</div></div>'
    '<div class="price-card down">'
    '<div class="pc-name">碳酸锂 <span class="pc-tag">电池级</span></div>'
    '<div class="pc-value">156,450</div>'
    '<div class="pc-unit">元/吨（SMM折）</div>'
    '<div class="pc-chg">&#9660; -523 (-0.33%)</div></div>'
    '<div class="price-card down">'
    '<div class="pc-name">电解钴 <span class="pc-tag">SMM</span></div>'
    '<div class="pc-value">304,940</div>'
    '<div class="pc-unit">元/吨（SMM折）</div>'
    '<div class="pc-chg">&#9660; -45 (-0.02%)</div></div>'
    '</div>\n'
)
