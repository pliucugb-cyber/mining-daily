...
报告日期 2026-09-22（周一盘前，国内未开盘；国内 SHFE/上金所最新收盘 09-18；LME 09-18 收盘，东财日K末点已追平）
...
_price_comment = ('- 周二盘前国内尚未开盘，最新为 09-21 日收盘：碳酸锂 +4.20%、沪铅 +0.55%、沪锌 +0.55%、沪铜 +0.51%、沪锡 +0.37% 上涨；白银 -1.01%、上海金 -0.89%、沪铝 -0.74%、沪镍 -0.31%。'
    'LME 六金属涨跌互现（行情末点与价格卡同源，均为 09-21 日收盘）：伦锡 +1.30%、伦镍 +0.92%、伦铅 +0.73%、伦铜 +0.70%、伦锌 -0.38%、伦铝 -1.12%。'
    '驱动上，铜价连续第五个交易日上涨，COMEX 12 月合约盘中一度涨 3.3% 至 6.8410 美元/磅，'
    '洋山铜溢价上周五报 124 美元/吨创近四年新高、周一回落至 119 美元/吨，LME 现货转为 26 美元/吨升水'
    '（一周前为贴水 86 美元）；美国 COMEX 仓库铜库存达 69.62 万吨、约占全球交易所监测库存 69%，'
    '新奥尔良港库容基本用满。锌端矿紧延续，9 月初进口锌精矿 TC 已跌至 -120 美元/吨、国内北方大区 -1500 元/吨，'
    '冶炼环节由盈转亏；铝方面 IAI 数据显示 8 月全球原铝产量同比下降 1.7% 至 617.2 万吨。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '伦锡 +1.30%、伦镍 +0.92%、伦铅 +0.73%、伦铜 +0.70% 领涨，伦锌 -0.38%、伦铝 -1.12%。'},
    {'cat': '行情', 'k': '',
     't': '国内 碳酸锂 +4.20%、沪铅 +0.55%、沪锌 +0.55% 领涨，白银 -1.01%、上海金 -0.89%。'},
    {'cat': '政策与产业', 'k': '南美四国',
     't': '智利、阿根廷、玻利维亚、秘鲁签署战略矿产联合声明，锂储量占全球已探明半数以上。'},
    {'cat': '政策与产业', 'k': '美国启动',
     't': '美国国防部面向铟、锰、镁、钛 4 种关键金属招标，覆盖采选冶到回收全链条。'},
    {'cat': '政策与产业', 'k': '印度放宽',
     't': '印度放宽矿山剥离物与表外矿环保审批，可申请改既有环评而无需重新申请。'},
    {'cat': '政策与产业', 'k': '北方矿业',
     't': '北方矿业完成印尼 KSK 铜金锌多金属项目收购交割，交接团队已进场。'},
    {'cat': '政策与产业', 'k': '中铝科学院',
     't': '中铝科学院建成国内首台套短流程连续气雾化制粉生产线，已签 100 千克粉体销售合同。'},
    {'cat': '政策与产业', 'k': '葛红林',
     't': '葛红林：全球再生金属占有色金属总产量比重由 2020 年 32% 升至 2025 年 36%。'},
    {'cat': '政策与产业', 'k': '中矿资源',
     't': '中矿资源赞比亚 Kitumba 铜矿采选工程全线贯通投料试生产，设计年产阴极铜 3.5 万吨。'},
    {'cat': '勘查与技术', 'k': '赞比亚卢安夏西',
     't': '科瑞克斯赞比亚卢安夏西铜矿启动 2500 米钻探，计划验证 3—4 个靶区。'},
    {'cat': '勘查与技术', 'k': '大洋金属',
     't': '大洋金属巴西塞拉内格拉稀土项目见矿 122 米、TREO 1.2%，矿化面积翻倍至 4.5 平方公里。'},
    {'cat': '勘查与技术', 'k': '中国恩菲',
     't': '中国恩菲难处理金矿提金技术突破，金浸出率提至 95% 以上、年多回收 15% 黄金。'},
    {'cat': '勘查与技术', 'k': 'Rincon',
     't': 'Argosy 阿根廷 Rincon 锂项目完成结晶试验，氯化锂收率超 99%。'},
    {'cat': '并购与投资', 'k': 'Capstone',
     't': 'Capstone 至多 3.85 亿美元出售墨西哥 Cozamin 铜矿给 Luca Mining。'},
    {'cat': '并购与投资', 'k': '藏格矿业',
     't': '藏格矿业以约 11.57 亿元收购刚果（布）Kanga Potash 92% 股权，已签买卖协议。'},
    {'cat': '并购与投资', 'k': '津巴布韦',
     't': '南非投资者 FS Mining 在津巴布韦开建 5 亿美元铬铁冶炼及电力项目。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿业权市场 9 月 21 日新增挂牌与协议出让公告，含阿拉善左旗尚丹铜多金属矿、新疆黄山东铜镍矿等。'},
]
