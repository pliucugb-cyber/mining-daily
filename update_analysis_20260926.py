...
报告日期 2026-09-26（周五盘前，国内未开盘；国内 SHFE/上金所最新收盘 09-24；LME 09-24 收盘，东财日K末点=09-24）
...
_price_comment = ('- 星期六 休市，国内最新为 09-24 日收盘：沪锌 +0.92%、沪锡 +0.45% 收涨，沪铜 -0.18%、沪铅 -0.40%、碳酸锂 -3.48%、白银 -3.12%、上海金 -1.26% 走弱。LME 六金属（行情末点与价格卡同源，均为 09-25 日收盘）：伦锡 +1.30%、伦铝 +0.80% 上涨，伦铜 -0.10%、伦铅 -0.13%、伦镍 -0.88%、伦锌 -1.80% 下跌。驱动上，国内基本金属窄幅整理，贵金属与碳酸锂延续承压；外盘除锡、铝收涨外多数回落。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': 'LME 锡 +1.30%、铝 +0.80% 上涨，锌 -1.80%、镍 -0.88% 下跌（09-25 收盘）。'},
    {'cat': '行情', 'k': '',
     't': '国内 09-24 收盘：沪锌 +0.92%、沪锡 +0.45% 收涨，碳酸锂 -3.48%、白银 -3.12% 走弱。'},
    {'cat': '政策与产业', 'k': '上期所',
     't': '上期所镍国际化业务全流程贯通，将进一步丰富国际化产品供给、优化业务规则。'},
    {'cat': '政策与产业', 'k': '地质灾害成功避险',
     't': '自然资源部通报表扬 1—7 月全国 370 起地质灾害成功避险案例。'},
    {'cat': '政策与产业', 'k': '德兴铜矿',
     't': '中国恩菲设计建设的德兴铜矿五号尾矿库数字运营系统通过上线试运行验收。'},
    {'cat': '政策与产业', 'k': '山东黄金',
     't': '山东黄金将 2026 年矿产金产量计划由不低于 49 吨下调至 36 吨—38 吨。'},
    {'cat': '政策与产业', 'k': 'Pitfield',
     't': 'Empire 从西澳 Pitfield 钛矿石制出金红石颜料，TiO₂ 品位约 99.2%。'},
    {'cat': '政策与产业', 'k': '华为',
     't': '华为在非洲关键矿产大会推介矿山微电网方案，与赞比亚国家电力公司洽谈绿电合作。'},
    {'cat': '勘查与技术', 'k': 'Boundiali',
     't': 'Aurum 科特迪瓦 Boundiali 金矿钻探见 1.3 米 155 克/吨高品位金。'},
    {'cat': '勘查与技术', 'k': 'Bonza Sur',
     't': 'Lundin Gold 厄瓜多尔 Bonza Sur 钻探品位创纪录，继续支持高品位矿化解释。'},
    {'cat': '并购与投资', 'k': '北方矿业',
     't': '北方矿业完成印尼 KSK 项目交割，将有序推进项目早日建成见效。'},
    {'cat': '并购与投资', 'k': '贵研铂业',
     't': '贵研铂业控股子公司拟 4.346 亿元投建高精度高性能复合材料生产基地。'},
    {'cat': '并购与投资', 'k': '亿纬锂能',
     't': '亿纬锂能以 11.5 亿元转让湖北恩捷新材料 45% 股权，不再持有该公司股权。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿权市场窗口内新增 1 宗：安徽宁国山屋岭角银多金属（鸡血石）矿探矿权转让公示。'},
