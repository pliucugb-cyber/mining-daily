...
report = """**总览：** 今日（09-06，周日休市，国内外均无新收盘，行情沿用 09-04 上一交易日收盘，与昨日一致）。市场维持“贵金属强、锂弱”的分化格局：国际钯价单日大涨 5.84% 至 1440.0 美元/盎司领涨，铂 +3.93%、银 +2.52%、金 +1.96% 至 4473.6 美元/盎司；国内上海金 Au99.99 报 965.96 元/克（+0.79%）、白银 Ag(T+D) 16,250 元/千克（+1.28%）。碳酸锂主力 GFEX 收 141,940 元/吨，09-04 单日 -5.30%，两日累计跌幅超 12%，仍是当前最弱品种。基本金属小幅分化：沪锌 +0.51%、沪铜 +0.34% 偏强，沪镍 -0.86%、沪铝 -0.33% 走弱；LME 六金属涨跌互现，锌 +1.10%、铜 +0.11% 小幅收涨，铝 -0.65%、镍 -0.41% 回落。

**今日头条：**
- 全球规模最大的难选铁矿流态化磁化焙烧工程在辽宁鞍山通过竣工验收：年处理 556 万吨，从含铁仅 11% 的铁尾矿稳定产出品位 65% 的铁精矿，铁矿物相转化率 98%、综合能耗较同类技术低 35%，有望带动国内近 300 亿吨难选铁矿与近 100 亿吨含铁尾矿开发，并已与老挝签订褐铁矿焙烧提质项目。
- 四川集中挂牌 2 宗探矿权：丹巴县天宝洞金矿（15.93 km²、起始价 128 万元）与乐山市金口河区鲤鱼堡铅锌矿（10.80 km²、87 万元），出让收益率均为 2.3%、年限 5 年、保证金各 1500 万元；后者明确不接受外商和外资竞买。
- 河北滦平县安纯沟门乡大西沟金矿勘查探矿权拍卖出让（承矿拍〔2026〕03 号），区块 4.37 km²、起始价 26.22 万元、保证金 100 万元，10 月 26 日 16 时截止缴纳。
- 两宗探矿权转让公示：内蒙古扎赉特旗黑大山金铜多金属矿（34.417 km²，喀喇沁旗天成美石转嘉石矿业）、吉林临江市小栗子银多金属矿详查（1.237 km²，转让人吉林星泰集团）。
- 中国地质调查局实施吉隆泥石流次生地质灾害监测：殷跃平院士牵头、18 名技术专家在错坚河口至拉比村核心风险带布设边坡雷达、雷视一体监测仪与微震监测仪，24 小时全自动观测预警。
- 贵州印发《非常规天然气增储上产三年攻坚行动方案（2026—2028 年）》，聚焦页岩气、煤层气部署六大方面 15 条举措，推动煤矿瓦斯由井下被动抽采转向地面主动预抽。
- 紫金矿业披露“三年规划和十年远景目标”：2028 年铜、金产量进入全球前 3 位，2035 年全面建成绿色高技术超一流国际矿业集团；一季度利润破 200 亿元创历史新高、同比近乎翻番。
- 矿山数字化提速：浙江交投矿业调度效率提升 10%，湖州新开元生产管控效率提升四成，嵩县山金实现关键固定设备无人值守，西部矿业锡铁山铅锌矿建成智慧矿山管控平台。
