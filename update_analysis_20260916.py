...
报告日期 2026-09-16（周三盘前；国内 SHFE/上金所最新收盘 09-15；LME 09-15 收盘）
...
_price_comment = ('- 周三盘前国内最新为 9 月 15 日收盘：沪铝逆势收红 +0.29% 为唯一上涨品种，沪铅 -0.32%、沪镍 -0.38%、白银 -0.49%、'
    '上海金 -0.57%、沪锌 -0.72%、沪铜 -0.75%，沪锡 -1.30% 领跌、碳酸锂 -2.43% 跌幅居前；'
    'LME 分化明显，伦锌 +0.71%、伦铜 +0.64%、伦锡 +0.49% 收涨，伦镍则重挫 3.04% 领跌。'
    '驱动上，市场聚焦本周美国通胀数据与美联储政策路径，美元与实际利率预期压制贵金属与基本金属；'
    '伦镍大跌与印尼镍铁、印尼新建商品交易所（ICOMEX）首批品种含锡和镍铁的供给格局重塑预期有关，'
    '锌则受加工费深度负值、矿端紧缺支撑相对抗跌。整体呈「宏观压制、品种分化」格局。')
...
BRIEF_DIGEST = [
    {'cat': '行情', 'k': '',
     't': '沪市 9 个品种仅沪铝收红（+0.29%），沪锡 -1.30%、碳酸锂 -2.43% 领跌，多数品种跌逾 0.3%。'},
    {'cat': '行情', 'k': '',
     't': 'LME 分化：伦锌 +0.71%、伦铜 +0.64%、伦锡 +0.49% 收涨，伦镍重挫 3.04% 领跌。'},
    {'cat': '政策与产业', 'k': '评审专家库',
     't': '自然资源部公示矿业权出让权限非油气矿产勘查方案评审专家库人员名单，强化勘查方案技术把关。'},
    {'cat': '政策与产业', 'k': '自律倡议',
     't': '《矿产资源对外合作可持续发展自律倡议》发布，近 30 家企业共同发起，覆盖海外勘探开发全链条。'},
    {'cat': '政策与产业', 'k': '秘鲁',
     't': '秘鲁推出矿业政务改革精简审批，未来 5 年力争 330 亿美元矿业投资、年内审批 240 个项目。'},
    {'cat': '政策与产业', 'k': '铝用炭素',
     't': '铝用炭素分会年度工作会在济南召开，上期所介绍石油焦期货品种开发研究进展。'},
    {'cat': '政策与产业', 'k': '锌价回落',
     't': '锌矿加工费深度负值（国产 TC 跌至 -2100 元/吨），协会提示锌价回落风险加大。'},
    {'cat': '政策与产业', 'k': '印尼新建',
     't': '印尼 ICOMEX 商品交易所拟 2027 年 1 月 4 日开市，首批上市品种含锡和镍铁。'},
    {'cat': '勘查与技术', 'k': '嘉能可科技',
     't': '嘉能可科技重启中国本土化运营，亮出艾萨磨机、詹姆森浮选机、阿尔比恩工艺三大核心技术。'},
    {'cat': '勘查与技术', 'k': '阿尔卡尼',
     't': '阿尔卡尼资源公司总矿石资源量 5.79 亿吨，金资源量 862 万盎司、锑 4.2 万吨。'},
    {'cat': '勘查与技术', 'k': '沙特麦地那',
     't': '沙特麦地那圈定 1.1 亿吨含铀矿石，伴生重稀土，铀品位与金属量尚未公布。'},
    {'cat': '并购与投资', 'k': '国城矿业',
     't': '国城矿业子公司签署合作框架协议暨关联交易进展，公司按规履行信息披露程序。'},
    {'cat': '并购与投资', 'k': '明泰铝业',
     't': '明泰铝业出售参股公司股权事项终止，原交易方案未能如期推进。'},
    {'cat': '并购与投资', 'k': '花秋二矿',
     't': '赤天化子公司安佳矿业花秋二矿扩建项目获主管部门批复，产能与经营规模有望提升。'},
    {'cat': '矿权市场', 'k': '',
     't': '矿权专区窗口内累计 49 宗（挂牌/协议/转让/结果/登记）；今日无新增出让公告，企业侧新增盛达资源采矿权延续登记。'},
]
