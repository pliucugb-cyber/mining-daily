# -*- coding: utf-8 -*-
"""注入 2026-09-10 矿权交易公告到 data/news_2026-09.json

- 7 宗：2 挂牌出让 / 1 出让结果 / 2 协议出让 / 2 转让公示
- 仅入 rightsSection 数据层（category=矿权交易），不进主页列表
- 字段：title/url/source/orig_date/orig_date_full/category/summary/embed
"""
...
ITEMS = [
    {
        ...
        'method': '挂牌出让', 'mineral': '安山岩', 'area_km2': '0.1049',
        'region': '新疆托里县', 'embed': 'ok',
    },
    {
        ...
        'source': '矿业权市场',
        'orig_date': '09-05',
        'orig_date_full': '2026-09-05',
        'category': '矿权交易',
        'summary': '四川省政府政务服务和公共资源交易服务中心受省自然资源厅委托，对马尔康市沙普金矿勘查探矿权进行网上挂牌出让，矿种为金矿，面积40.9006平方千米，位于阿坝州马尔康市。',
        'method': '挂牌出让', 'mineral': '金矿', 'area_km2': '40.9006',
        'region': '四川阿坝州马尔康市', 'embed': 'ok',
    },
    {
        'title': '山东省自然资源厅山东省乳山市金青顶外围金矿普查探矿权挂牌出让结果公示',
        'url': 'https://ky.mnr.gov.cn/jggs/jjgs/202609/t20260904_10305944.htm',
        'source': '矿业权市场',
        'orig_date': '09-04',
        'orig_date_full': '2026-09-04',
        'category': '矿权交易',
        'summary': '山东省公共资源交易中心挂牌出让乳山市金青顶外围金矿普查探矿权，竞得人为山东金洲矿业集团有限公司，矿种为金矿，面积10.830平方千米。',
        'method': '出让结果', 'mineral': '金矿', 'area_km2': '10.830',
        'region': '山东乳山市', 'embed': 'ok',
    },
    {
        ...
        'method': '协议出让', 'mineral': '银铅锌', 'area_km2': '5.5428',
        'region': '内蒙古锡林郭勒盟阿巴嘎旗', 'embed': 'ok',
    },
    {
        ...
        'method': '协议出让', 'mineral': '铁矿', 'area_km2': '11.7923',
        'region': '内蒙古巴彦淖尔市乌拉特前旗', 'embed': 'ok',
    },
    {
        ...
        'method': '协议出让', 'mineral': '金矿', 'area_km2': '1.2686',
        'region': '内蒙古赤峰市宁城县', 'embed': 'ok',
    },
    {
        ...
        'method': '转让公示', 'mineral': '金多金属', 'area_km2': '',
        'region': '辽宁岫岩县', 'embed': 'ok',
    },
]
